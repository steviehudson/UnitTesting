...
namespace UnitTesting
{
  public class PersonManager
  {
    ...
    public List<Person> GetPeople()
    {
      ...
      people.Add(new Person() { FirstName = "Stephanie", LastName = "Hudson" });
      people.Add(new Person() { FirstName = "Stevie", LastName = "Huds" });
      people.Add(new Person() { FirstName = "Steph", LastName = "Hud" });
